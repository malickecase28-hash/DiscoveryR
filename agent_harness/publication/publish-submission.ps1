...
try {
    ...
    [IO.File]::WriteAllText((Join-Path $destination 'submission_manifest.json'), ((($submissionManifest|ConvertTo-Json -Depth 20) -replace "`r`n", "`n")+"`n"), [Text.UTF8Encoding]::new($false))
